...
今回は「**REST Countries API」**を利用して、世界中の国の情報をReactから取得・表示してみましょう。

---

## 前提

- 使用API：**REST Countries API**
- 公式ドキュメント：[https://restcountries.com](https://restcountries.com/)
- APIキー不要（無料で利用可能）
...
1. プロジェクト作成
    1. プロジェクト名は「country-info-viewer」
    2. 必要なライブラリは以下の通り
    コピペ用コマンド：`npm install @mui/material @mui/icons-material @emotion/react @emotion/styled`
        1. `@mui/material`
...
const CountryList: React.FC = () => {
  // TODO: propsで受け取った国データをmapで展開してCountryItemを表示（タスク1）
  return (
